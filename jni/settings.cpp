...
CSettings::CSettings()
{
	...
	// gui
	length = reader.Get("gui", "ClockText", "SA:MP").copy(m_Settings.szClockText, MAX_CLOCK_BYTE);
	m_Settings.szClockText[length] = '\0' ;
	m_Settings.bEnableClock = reader.GetBoolean("gui", "EnableClock", false);
